window.addEventListener('load', () => {
    ...
    document.getElementById('selected-vehicle').value = carOption;
     document.getElementById('discounted-price').value = 35;
  
        
    }else if (carOption1 == "SUV/ Crossover"){
        document.getElementById('selected-vehicle').value = carOption1;
    document.getElementById('discounted-price').value = 40;
  
  
    } else if(carOption2 == "10 Seater Van") {
        document.getElementById('selected-vehicle').value = carOption2;
     document.getElementById('discounted-price').value = 50;
